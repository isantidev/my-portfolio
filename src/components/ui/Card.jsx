                ...
                <div className="@container">
                    <div className="flex justify-between max-h-10 mt-4 gap-2">
                        ...
                        <a
                            ...
                            className="p-2 w-12 bg-custom-secondary/40 text-custom-bg rounded-sm capitalize [&_svg]:size-full inline-flex gap-4 items-center justify-center cursor-pointer @xs:w-full @xs:[&_svg]:size-4"
                        >
                            <svg>
