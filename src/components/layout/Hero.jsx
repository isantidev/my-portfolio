...
const Hero = () => {
    return (
        <>
            <section
                aria-label="about-me"
                className="py-24 md:h-auto md:py-36 scroll-m-20 w-full mx-auto lg:max-w-screen-xl md:max-w-2xl px-4"
                id="Hero"
            >
                <div className="flex flex-col items-center justify-between gap-4 md:grid md:grid-cols-3 md:place-items-center md:gap-8">
                    ...
                    <article className="flex flex-col max-w-xl h-full gap-2 justify-between items-center text-center md:col-span-2 md:items-start">
                        <h1 className="text-pretty md:text-left">
                            Hey, I'm Kevin Sierra
                        </h1>
                        <p className="text-balance text-xl md:text-left max-w-md">
